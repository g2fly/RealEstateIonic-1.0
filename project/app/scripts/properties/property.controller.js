(function() {
	...
	PropertyController.$inject = [
		'property', 'externalAppsService', 'distanceService', '$state', 'favoritePropertiesService', 'ionicToast', '$ionicHistory'];

	/* @ngInject */
	function PropertyController(property, externalAppsService, distanceService, $state, favoritePropertiesService, ionicToast, $ionicHistory) {
		...
		function showFavorites() {
			$state.go('app.favorite-properties', {
